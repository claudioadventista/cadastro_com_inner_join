...
if((isset($_POST['submitCadastro']))AND($_POST['submitCadastro']=="EXISTENTE")){
   ...
   mysqli_query($conexao, $sql) or die('Error: '.mysqli_error($conexao)); 
    ...
    // clia um novo cadastro existente
    ...
    mysqli_query($conexao, "SET NAMES 'utf8';");
    $sql = "INSERT INTO cadastro (ordem_servico, id_cliente, id_aparelho, id_marca, id_estado, dataEntrada, 
    numeroSerie, modelo, defeitoReclamado, dataPronto, acessorio, dataSaida, obs, material, orcamento, barra ) 
    VALUES ('$ordemServico','$id_cliente','$id_aparelho','$id_marca','$id_estado','$dataEntrada','$numeroSerie',
...
if((isset($_POST['submitCadastro']))AND($_POST['submitCadastro']=="NOVO")){
   ...
   // exit;
    ...
    mysqli_query($conexao, "SET NAMES 'utf8';");
    $sql = "INSERT INTO cliente (nome, telefone, telefone2, endereco, cpf, dataNascimento, dataCadastro, email, barra) 
    VALUES ('$nome','$telefone','$telefone2','$endereco','$cpf','$dataNascimento','$dataCadCliente','$email','$barra')";
    mysqli_query($conexao, $sql) or die('Error: '.mysqli_error($conexao));
    ...
    if((isset($_POST['novoAparelho']))AND($_POST['novoAparelho']<>"")){
        $novoAparelho = $_POST['novoAparelho'];
    ...
    mysqli_query($conexao, "SET NAMES 'utf8';");
    $sql = "INSERT INTO cadastro (ordem_servico, id_cliente, id_aparelho, id_marca, id_estado, barra, 
    numeroSerie, modelo, defeitoReclamado, acessorio, obs, material, orcamento, dataEntrada) 
    VALUES ('$ordem_servico','$id_cliente','$id_aparelho','$id_marca','$id_estado','$barraCadastro',
